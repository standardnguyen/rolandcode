...
test("parses valid share URLs", () => {
  expect(parseShareUrl("https://example.com/share/Jsj3hNIW")).toBe("Jsj3hNIW")
...
test("rejects invalid URLs", () => {
  expect(parseShareUrl("https://example.com/s/Jsj3hNIW")).toBeNull() // legacy format
  expect(parseShareUrl("https://example.com/share/")).toBeNull()
  expect(parseShareUrl("https://example.com/share/id/extra")).toBeNull()
