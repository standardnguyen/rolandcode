...
const TIPS = [
  ...
  "RolandCode auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "RolandCode auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "RolandCode uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent RolandCode from reading sensitive files",
  "Use {highlight}rolandcode run{/highlight} for non-interactive scripting",
  "Use {highlight}rolandcode --continue{/highlight} to resume the last session",
  "Use {highlight}rolandcode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}rolandcode serve{/highlight} for headless API access to RolandCode",
  "Use {highlight}rolandcode run --attach{/highlight} to connect to a running server",
  "Run {highlight}rolandcode upgrade{/highlight} to update to the latest version",
  "Run {highlight}rolandcode auth list{/highlight} to see all configured providers",
  "Run {highlight}rolandcode agent create{/highlight} for guided agent creation",
  "Use {highlight}/rolandcode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}rolandcode github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/rolandcode fix this{/highlight} on issues to auto-create PRs",
  "Comment {highlight}/rc{/highlight} on PR code lines for targeted code reviews",
  ...
  "Run {highlight}rolandcode debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} to configure your preferred LLM providers",
